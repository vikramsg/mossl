...
fn test_hkdf_rfc5869_case1() raises:
    ...
    assert_equal(prk_hex, "077709362c2e32df0ddc3f0dc47bba6390b6c73bb50f9c3122ec844ad7c2b3e5")

    var okm = hkdf_expand(prk, info, 42)
    var okm_hex = bytes_to_hex(okm)
    assert_equal(okm_hex, "3cb25f25faacd57a90434f64d0362f2a2d2d0a90cf1a5a4c5db02d56ecc4c5bf34007208d5b887185865")
