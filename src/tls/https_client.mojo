...
struct TLSConnectionAdapter[T: TLSTransport](Movable, HTTPReader):
...
fn _read_until_eof[R: HTTPReader](
    ...
    mut conn: R, timeout_seconds: Float64 = 5.0
...
fn _read_chunked_bytes[R: HTTPReader](mut conn: R, payload: Bytes) raises -> Bytes:
...
fn _read_response[R: HTTPReader](mut conn: R, initial: Bytes) raises -> HTTPResponse:
